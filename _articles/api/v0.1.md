...
{% include message_box.html type="note" title="`_download_url_`" content="
...
```
{% include message_box.html type="note" title=“ When does the `_download_url_` get generated" content="`_download_url_` is generated only when the build certificate's `_is_protected_` attribute is `_false_`. 
"%}
...
{% include message_box.html type="important" title="Do not include special headers when sending `GET` request" content="
