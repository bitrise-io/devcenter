---
title: Device testing for Android-fix
date: 2018-11-16 11:40:27 +0000
redirect_from: []
published: false
...
**{% include message_box.html type="note" title="Limitations" content="You might be limited with your overall build time. Also note that a single build can only contain one** `**\[BETA\] Virtual Device Testing**` **Step performing one type of test.** 
