...
* [Before setting up an Ionic/Cordova project](/getting-started-with-ionic-cordova-apps/#before-setting-up-an-ioniccordova-project/)
* [Adding an Ionic/Cordova project to Bitrise](/getting-started-with-ionic-cordova-apps/#adding-an-ioniccordova-app-to-bitrise/)
* [Dependencies](/getting-started-with-ionic-cordova-apps/#dependencies/)
* [Testing Ionic/Cordova apps](/getting-started-with-ionic-cordova-apps/#testing-ioniccordova-apps/)
* [Code signing](/getting-started-with-ionic-cordova-apps/#code-signing/)
* [Deploying Ionic/Cordova apps](/getting-started-with-ionic-cordova-apps/#deploying-ioniccordova-app/)
