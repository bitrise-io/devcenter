...
Bitrise is not an integrated application in the Microsoft Azure portal so to set up SAML SSO with Azure, you will have to first add Bitrise as a non-gallery app to the portal.
