...
* A Bitrise Workspace owner who is logged into the Workspace (with [Velocity subscription](https://www.bitrise.io/pricing/teams "https://www.bitrise.io/pricing/teams")) on [Bitrise](https://www.bitrise.io).
...
## Configuring Bitrise on OneLogin
 ...
 6. Click the **Configuration** tab again and paste the **Single Sign-On URL** from your Bitrise Workspace’s **Single Sign On** tab to the **Single Sign-On URL** field on OneLogin. Hit **Save**.
...
4. On the **Allow “Workspace name”** **to sign you in** window, click **Authorize** if you trust the Workspace.

You should be landing on your Bitrise Dashboard. If you go to your Workspace's **Groups** tab, you can see that you are automatically added as a SAML user. All Workspace members, who enable SAML SSO, appear here automatically. From now on you can log into your Bitrise Workspace with SAML SSO.
