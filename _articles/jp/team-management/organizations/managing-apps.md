...
4. `Transfer apps`をクリックします
   ...
   ![{{ page.title }}](/img/team-management/organization/transfer-app-org.png)
...
5. `Assign group to apps`をクリックします。
   ...
   ![{{ page.title }}](/img/team-management/organization/assign-group-to-apps.png)
6. 必要なアプリを見つけて、そのグループに適切な役割を選択します。どんなアプリの`Team`タブのロールチートシートを確認することができます。

   ![{{ page.title }}](/img/team-management/organization/assign-group-popup.png)
