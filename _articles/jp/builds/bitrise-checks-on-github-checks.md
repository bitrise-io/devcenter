...
![](/img/enabled-toggle-githubchecks.jpg) {% include message_box.html type="warning" title="**ENABLE GITHUB CHECKS** switch error" content="Learn when **ENABLE GITHUB CHECKS** toggle does not work and what you can do:
