...
Packages/dependencies can disappear from the dependency manager. This can break the project at/**for** the worst time and is avoidable by not relying on the dependency manager.
