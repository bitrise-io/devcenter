...
![](https://bitrise.atlassian.net/img/stack-selector.png)
...
For native Android apps, the recommended stack is still the [Android & Docker stack](https://bitrise.atlassian.net/infrastructure/the-environment/) - it will surely serve all your needs.
