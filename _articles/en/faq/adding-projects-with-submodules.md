...
[GitHub itself recommends this method](https://developer.github.com/v3/guides/managing-deploy-keys/#machine-users) for accessing multiple repositories. Let’s quickly go through an example. If you already understand the concept and just need the step-by-step guide to get it done, go to the [Using a machine user to access private repositories](/faq/adding-projects-with-submodules/#using-a-machine-user-to-access-private-repositories) section. 
