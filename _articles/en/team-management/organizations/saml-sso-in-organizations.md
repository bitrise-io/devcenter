...
* Your account on Bitrise has a [Velocity plan](https://www.bitrise.io/pricing) or an Org Elite plan. If it doesn’t have a Workspace, go ahead and [create one](/team-management/organizations/creating-org/). Setting up SAML SSO is the same for existing and brand new Workspaces on Bitrise.
