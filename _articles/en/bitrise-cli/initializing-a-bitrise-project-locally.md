...
{% include video.html embed_url="https://www.youtube.com/embed/ZKF-gzvn1mw" %}
...
{% include banner.html banner_text="Explore Bitrise from your Terminal" url="https://app.bitrise.io/cli" button_text="Go to the Bitrise CLI" %}