...
{% include message_box.html type="info" title="How can I get notified?" content="You can get notified about a successful or failed build if you click the **Watch** icon above the **Start/Schedule a Build** purple button on your Build's page."%}
