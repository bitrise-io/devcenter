...
{% include message_box.html type="example" title="Step input" content=" `yaml - my_key_for_the_env: my value for the env opts: title: An example env var item is_dont_change_value: false category: example`
"%}
