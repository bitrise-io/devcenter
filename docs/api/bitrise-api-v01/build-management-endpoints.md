[`GET /apps/{APP-SLUG}/builds`: Get the builds of a specific app.](#get-appsapp-slugbuilds)

[`GET /apps/{APP-SLUG}/builds/{BUILD-SLUG}`: Get a specific build's data.](#get-appsapp-slugbuildsbuild-slug)

[`GET /apps/{APP-SLUG}/builds/{BUILD-SLUG}/log`: Get the log info of a specific Build.](#get-appsapp-slugbuildsbuild-sluglog)

[`GET /apps/{APP-SLUG}/builds/{BUILD-SLUG}/artifacts`: Get the artifacts for a specific build.](#get-appsapp-slugbuildsbuild-slugartifacts)

[`GET /apps/{APP-SLUG}/builds/{BUILD-SLUG}/artifacts/{ARTIFACT-SLUG}`: Get a certain build artifact's data.](#get-appsapp-slugbuildsbuild-slugartifactsartifact-slug)

[`PATCH /apps/{APP-SLUG}/builds/{BUILD-SLUG}/artifacts/{ARTIFACT-SLUG}`: Set the attributes of a build artifact.](#patch-appsapp-slugbuildsbuild-slugartifactsartifact-slug)

[`POST /apps/{APP-SLUG}/builds`: Trigger a new build.](#post-appsapp-slugbuilds)

[`POST /apps/{APP-SLUG}/builds/{BUILD-SLUG}/abort`: Abort a running build.](#post-appsapp-slugbuildsbuild-slugabort)
...
Request with `commit_message` filtering (builds with commit message):
...
Request with `build_number` filtering (builds with commit message):
...
{
  "build_number": 34,
  "build_slug": "226f809ae60c822d",
  "build_url": "https://www.bitrise.io/build/226f809ae60c822d",
