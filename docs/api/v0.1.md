...
```
curl -X POST -H  'Authorization: token THE-ACCESS-TOKEN' 'https://api.bitrise.io/v0.1/apps/APP-SLUG/provisioning-profiles/01C6FA6P6HRQT5PQ8RMMVVXE6W/uploaded'
```
...
```
curl -X PATCH -H  'Authorization: token THE-ACCESS-TOKEN' 'https://api.bitrise.io/v0.1/apps/APP-SLUG/provisioning-profiles/01C6FA6P6HRQT5PQ8RMMVVXE6W -d '{"is_protected":true}'
```
...
```
curl -X POST -H 'Authorization: token THE-ACCESS-TOKEN' 'https://api.bitrise.io/v0.1/apps/APP-SLUG/build-certificates/01C6FA2R4CB772QTDETBE0MENP/uploaded'
```
...
```
curl -X PATCH -H  'Authorization: token THE-ACCESS-TOKEN' 'https://api.bitrise.io/v0.1/apps/APP-SLUG/build-certificates/01C6FA2R4CB772QTDETBE0MENP -d '{"is_protected":true}'
```
...
- **`created_by`:** descending order by the `created_at` attribute (default setting)
