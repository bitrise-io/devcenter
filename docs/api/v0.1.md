...
_Note: at this time only the `is_public_page_enabled` attribute can be set through this endpoint call. This attribute can olny set for the artifacts with type `android-apk` or `ios-ipa`._
