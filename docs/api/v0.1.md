...
Request with `branch` filtering:
```
curl -H 'Authorization: token THE-ACCESS-TOKEN' 'https://api.bitrise.io/v0.1/apps/APP-SLUG/builds?branch=master'
```
...
```
{
  "data": [
    ...
    },
    {
      ...
      "status_text": "success",
      "tag": null,
      "triggered_at": "2017-05-16T20:02:25.731237Z",
      "triggered_by": null,
      "triggered_workflow": "primary"
    },
    {
      ...
      "status_text": "success",
      "tag": null,
      "triggered_at": "2017-05-16T20:00:18.200472Z",
      "triggered_by": null,
      "triggered_workflow": "primary"
    },
    {
      ...
      "status_text": "success",
      "tag": null,
      "triggered_at": "2017-05-16T19:59:04.777164Z",
      "triggered_by": null,
      "triggered_workflow": "primary"
    },
    {
...
```
curl -H 'Authorization: token THE-ACCESS-TOKEN' 'https://api.bitrise.io/v0.1/apps/APP-SLUG/builds?trigger_event_type=push'
```
